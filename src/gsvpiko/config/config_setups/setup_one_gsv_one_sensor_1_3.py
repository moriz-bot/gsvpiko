"""Setup preset for one GSV-8 device with one 3-axis force sensor on socket 1/3."""
...
SETUP = {
    "name": "one_gsv_one_sensor_1_3",
    "description": (
        "One GSV-8 device with one 3-axis force sensor on the 1/3 SubD44HD socket, "
